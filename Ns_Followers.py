...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='62429986098' #Enter UserID Here
        self.__username='marvelidnne882' #Enter UserName Here
        self._session='62429986098:JxIUZUgZGMoCSK:22:AYcMr58WufOnW_cJLapBOaAnQwAUOMOvFaOwaRBhow' #Enter SessionID Here
